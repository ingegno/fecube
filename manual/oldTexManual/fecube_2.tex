...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_test1/Fe_cube_03_cube_test1.ino\string"}{5}{11}
...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_test1/Fe_cube_03_cube_test1.ino\string"}{15}{24}
...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_test1/Fe_cube_03_cube_test1.ino\string"}{217}{221}
...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_test1/Fe_cube_03_cube_test1.ino\string"}{245}{251}
...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_test1/Fe_cube_03_cube_test1.ino\string"}{109}{148}
...
\eng{
The entire code is given in Code \url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_03_cube_pattern/Fe_cube_03_cube_pattern.ino} %\ref{c:ledcube_snake}.
}

\ned{
De vollige code kun je vinden op \url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_03_cube_pattern/Fe_cube_03_cube_pattern.ino} %\ref{c:ledcube_snake}.
}

% \begin{code}\label{c:ledcube_snake}
%  \ \newline
% \inputardfull{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_pattern/Fe_cube_03_cube_pattern.ino\string"}
% \end{code}
...
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_intpattern/Fe_cube_03_cube_intpattern.ino\string"}{18}{67}

%\begin{code}\label{c:ledcube_heart}
% \ \newline
%\inputardfull{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_intpattern/Fe_cube_03_cube_intpattern.ino\string"}
%\end{code}
...
The other new variable is \ardo{starteffect}. That is, we need not wait for an extend to apply an effect, we can do it from the start. To show what is possible with effects, we manipulate the red snake pattern in 4 different ways, as well as adding a beating heart pattern. The full code is in \url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_03_cube_intpattern/Fe_cube_03_cube_intpattern.ino}. Only the start of the \ardo{moviepattern} function with the two switch statements is something you would want to change for your own patterns. See Code
...
De andere nieuwe variabele is \ardo{starteffect}. Dit is het effect die we vanaf de start toepassen. Om te tonen wat mogelijk is met de effecten manipuleren we de rode slang op 4 verschillende manier, en voegen we het kloppend hart shot toe. De volledige code is in \url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_03_cube_intpattern/Fe_cube_03_cube_intpattern.ino}.
...
\begin{code}\label{c:int_pat}
 \ \newline
\inputard{\string"../../sketches/old_versions/v01/Fe_cube_03_cube_intpattern/Fe_cube_03_cube_intpattern.ino\string"}{211}{293}
\end{code}
...
\begin{code}\label{c:pbtn}
 \ \newline
\inputardfull{\string"../../sketches/old_versions/v01/Fe_cube_05_pbtn/Fe_cube_05_pbtn.ino\string"}
\end{code}
...
\begin{code}\label{c:pbtn_event}
 \ \newline
\inputardfull{\string"../../sketches/old_versions/v01/Fe_cube_05_pbtn_events/Fe_cube_05_pbtn_events.ino\string"}
\end{code}
...
\end{itemize}
The full code is in \url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_05_cube_pbtn/Fe_cube_05_cube_pbtn.ino}.
}
...
\url{https://github.com/ingegno/fecube/blob/master/sketches/old_versions/v01/Fe_cube_05_cube_pbtn/Fe_cube_05_cube_pbtn.ino}.
}
