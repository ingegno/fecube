...
\begin{enumerate}
 \item We need for 9 LED what color they must have. A color is a RGB value like (13,50,2), so in base 64. That is, we need 27 numbers to form a frame now.
 \item We need to know how long to hold a frame before moving to the next frame. So, we need an extra number for the milliseconds to accompany the frame in the pattern.
\end{enumerate}
Therfore, a pattern will look like a list of numbers which indicate the different frames and how long they take. For a single frame this will be:\newline
