...
\caption{4 frames to make a moving horse. The full animation: \href{http://en.wikipedia.org/wiki/File:Horse\_gif.gif}{Wikipedia Horse\_gif} - 4 frames om een bewegend paard te maken. De volledige animatie: \href{http://en.wikipedia.org/wiki/File:Horse\_gif.gif}{Wikipedia Horse\_gif}}
\label{f:horse_movie}
\end{figure}
...
\engo{\begin{doE}
      ...
      Tip: For example, if the shot is 60 seconds, show on 6 seconds, off 6 seconds, on 3 seconds, off 3 seconds, on 1.5 seconds, off 1.5 seconds, .... The time is the framenumber times 40ms. 

      Nicer: mix, this is blinking sequentially two different colors always faster. You should see them mix in front of you.
     \end{doE}
}
\nedo{\begin{doN}
      \textbf{Jouw shot}. Maak nu je eigen shot. Bevoorbeeld, knipper de led altijd maar sneller en sneller.
      
      Tip: Bevoorbeeld, als je shot 60 seconden is, toon de led 6 seconden aan, 6 uit, dan 3 aan, dan 3 uit, dan 1.5 seconden aan, dan 1.5 af, ... De tijd is het frame nummer maal 40 ms.

      Mooier: mengen, dit is twee kleuren afwisselend knipperen, en dit versnellen. Je zou de kleuren moeten zien vermengen.
     \end{doN}
}
