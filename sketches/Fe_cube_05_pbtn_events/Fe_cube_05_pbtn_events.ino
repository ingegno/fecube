...
#define LONGPRESSMAXDURATION  5000UL
#define DOUBLEPRESSWAIT       700UL
...
void  eventhandling(){
  ...
  switch (event) {
    case BTNFIXED:
      // if no event, we can have a long press
  ...
  if (test && event != BTNFIXED){
    Serial.print(presstype);Serial.print(" "); Serial.println(timepressed - prevtimereleased);
  }
  // presstype has been set. The application should process it and set it to NOPRESS
}
